...
- Kept the same edge case handling (n <= 0 returns empty list)
- Maintained the same variable names and structure
- Ensured the same matrix generation pattern
- Kept the same loop conditions and increment logic
- Preserved the exact same return value format
- Made only minimal formatting improvements (consistent spacing)
- Maintained all original comments (none were present)
